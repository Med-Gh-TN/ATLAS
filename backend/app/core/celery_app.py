...
celery_app = Celery(
    ...
    include=[
        "app.services.ocr_tasks",
        "app.services.embedding_tasks" # CRITICAL: Added missing embedding tasks for pgvector pipeline
    ]
)
...
celery_app.conf.update(
    ...
    # Task time limits to prevent hanging OCR/Embedding processes (Optional but recommended)
    task_acks_late=True
)