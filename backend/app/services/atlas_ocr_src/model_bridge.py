...
from app.services.atlas_ocr_src.infrastructure.llm.bridge import (
    OmniModelBridge,
    raw_colbert_embed,
    _INGESTION_ACTIVE
)
...
import app.services.atlas_ocr_src.infrastructure as infrastructure.llm.bridge as _llm_bridge